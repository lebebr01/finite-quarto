...
[**mars**](https://mars.brandonlebeau.org) [![CRAN_Status_Badge](https://www.r-pkg.org/badges/version/mars)](https://cran.r-project.org/package=mars) This package estimates meta-analytic models to help with research syntheses. The estimation is written directly via the log-likelihood with further extensions planend soon. 
